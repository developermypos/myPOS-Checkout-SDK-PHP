 ...
 */
class AuthorizationCapture extends Base
{
    ...
    public function process()
    {
        ...
        $this->_addPostParam('IPCmethod', 'IPCAuthorizationCapture');
    ...
    public function validate()
    {
        ...
        if (!Helper::versionCheck($this->getCnf()->getVersion(), '1.4')) {
            throw new IPC_Exception('IPCVersion ' . $this->getCnf()->getVersion() . ' does not support IPCAuthorizationCapture method. Please use 1.4 or above.');
        }
     ...
     * Sets the partner ID.
     *
     * @param mixed $partnerID The partner identifier.
     *
     * @return $this
     */
